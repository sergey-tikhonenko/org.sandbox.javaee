...
@WebServlet("/SecurityCheckEjbError")
@ServletSecurity(@HttpConstraint(rolesAllowed = "UserViewer"))
public class CheckSecurityEjbErrorServlet extends HttpServlet {

    private static final long serialVersionUID = 2028633850828140266L;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String principal = service.alowedForUserEditor();
